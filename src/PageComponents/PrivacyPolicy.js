    ...
    <main className="page">
      <div className="container">
        ...
        <div>
          <br />
          <p>
            My personal portfolio website's{" "}
            <a
              href="https://maysengreenwood.me"
              target={"_blank"}
              rel={"noreferrer"}
            >
              maysengreenwood.me
            ...
            recorded by My personal portfolio website and how we use it.
          </p>
          <p>
            <br />
          </p>
          ...
          <p>
            ...
            that they shared and/or collect in&My personal portfolio website.
          ...
          <p>
            ...
            at the point we ask you to provide your personal information. We use
            Google Analytics to track behaviour on the site itself, and no
            personable, identifying data is tracked.
          </p>
          <p>
            <br />
          </p>
          ...
          <p>
            My personal portfolio website follows a standard procedure of using
          ...
          <p>
            Like any other website, My personal portfolio website uses
          ...
          <p>
            Note that My personal portfolio website has no access to or control
          ...
          <p>
            My personal portfolio website's Privacy Policy does not apply to
          ...
          <p>
            ...
            <a href="https://www.privacypolicygenerator.info/privacy-policy-cookies-clauses/">
              <span className="s1">What Are Cookies?</span>
            </a>
          </p>
          <p>
            <br />
          ...
          <p>
            ...
            us <a href="mailto:greenwood.maysen@gmail.com">here</a>.
          </p>
        </div>
      </div>
    </main>
